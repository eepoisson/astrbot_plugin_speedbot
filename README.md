...
🚀 发布说明 — v1.0.0
建议你在 GitHub 上创建 tag v1.0.0 并使用以下内容作为 Release Notes：

标题
v1.0.0 — SpeedBot 加速引擎首个正式版

正文
🚀 SpeedBot 加速引擎 — 多维度加速 AstrBot 响应速度的插件，从 6 个维度将响应时间从秒级压缩到毫秒级。
已针对 DeepSeek 3.2 Reasoner（deepseek-reasoner） 模型进行专项调优。
...
完整变更日志：https://github.com/eepoisson/astrbot_plugin_speedbot/commits/v1.0.0
